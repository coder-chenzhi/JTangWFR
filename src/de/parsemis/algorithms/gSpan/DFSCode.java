...
//		return first == null ? 0 : first.hashCode();
        GSpanEdge<NodeType,EdgeType> current = first;
        int result = 1;
        while (current != null) {
...
//				}
	...
	public void store(final Collection<Fragment<NodeType, EdgeType>> set) {
		Fragment<NodeType, EdgeType> fragment = toCleanFragment();
		set.add(fragment);
		DFSCodeUtil.fragcodes.put(fragment.toGraph().getName(), this.toString());
	}
