...
public class MinExtension<NodeType, EdgeType> extends
	...
	public MinExtension<NodeType, EdgeType> forward, backward;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.parsemis.algorithms.gSpan.GSpanEdge#release(de.parsemis.algorithms.gSpan.GThreadEnvironment)
	 */
	@Override
