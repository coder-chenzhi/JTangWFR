...
import de.parsemis.strategy.RecursiveStrategy4DFSCode;
...
public final class Settings<NodeType, EdgeType> {
	...
	public final static <NodeType, EdgeType> Settings<NodeType, EdgeType> create(
		...
		if (set.distributionScheme.equals("threads")) {
			...
			set.strategy = new RecursiveStrategy();
		} else if (set.distributionScheme.equals("dfscode")) {
			set.strategy = new RecursiveStrategy4DFSCode();
		} else if (set.distributionScheme.equals("dfscodes")) {
			set.strategy = new RecursiveStrategy();
		} else {
	...
	private final static <NodeType, EdgeType> boolean parseOption(
		...
		if (temp[0].equals("--help")) {
			...
			} else if (temp[1].equals("gspan4dfscode")) {
				set.algorithm = new de.parsemis.algorithms.gSpan.Algorithm4DFS<NodeType, EdgeType>();
			} else {
				throw new IllegalArgumentException(
